...
expName = 'grating_test'  # from the Builder filename that created this script
expInfo = {
...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='C:\\Users\\imprs_01\\Desktop\\grating_test.py',
...
grating = visual.GratingStim(
    ...
    ori=0.0, pos=(0, 0), size=(2,1), sf=5.0, phase=1.0,
...
while continueRoutine and routineTimer.getTime() < 120.0:
    ...
    if grating.status == STARTED:
        ...
        if tThisFlipGlobal > grating.tStartRefresh + 120-frameTolerance:
